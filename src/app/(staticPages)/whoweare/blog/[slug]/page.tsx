      ...
      <Container>
        ...
        >
          ...
          <div className="bg-[#FFE8A3] text-[#232323] rounded-lg p-8 mb-12 relative">
            <div className="absolute -top-4 left-6 text-[#FFB400] text-5xl">&ldquo;</div>
            <p className="text-center italic max-w-3xl mx-auto">
              {`Lorem ipsum dolor sit amet consectetur. Quam amet aliquam adipiscing elementum mauris consectetur senectus egestas dui. Nulla aenean eget amet sapien in consequat.`}
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2 mb-6">
            {['Back to School','Children','Outreach'].map(tag => (
              <span key={tag} className="px-3 py-1 bg-[#FFE8A3] text-[#232323] rounded-full text-sm">
                {tag}
              </span>
            ))}
          </div>
