    ...
    <main className="bg-whero bg-black bg-cover bg-center bg-no-repeat h-[100vh] relative">
      <Container>
        <section className="text-white pt-[4rem] xl:pt-[8rem]">
          <div className="">
            <h1 className="text-4xl text-center md:text-left md:text-6xl font-bold  mb-1">
              We Care.
            </h1>
            <h1 className="text-4xl text-center md:text-left md:text-6xl font-bold  mb-1">
          ...
          <p className="w-full md:w-[32rem] text-lg md:text-xl mb-6 text-center md:text-left">
