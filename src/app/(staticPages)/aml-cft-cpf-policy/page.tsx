...
const sections: Section[] = [
  {
    ...
    blocks: [
      {
        type: "p",
        text: "The Destiny Trust Children Foundation (“The Destiny Trust” or the “Organisation”) is committed to the highest standards of integrity, transparency, accountability, and responsible stewardship in the receipt, management, and application of funds and resources entrusted to it.",
      },
      {
        type: "p",
